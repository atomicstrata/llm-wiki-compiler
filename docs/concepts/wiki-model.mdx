...
description: "Learn how llmwiki organizes compiled wiki pages, wikilinks, the activity journal, and the .llmwiki directory for embeddings and state."
---
...
.llmwiki/
  ...
  embeddings.json       page- and chunk-level embedding vectors
