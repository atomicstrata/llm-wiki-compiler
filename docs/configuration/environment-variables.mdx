...
`.llmwiki/quarantined-embeddings.json` from your project and run `llmwiki compile`
with refreshes enabled. This resets their retry budget and may incur costs.
