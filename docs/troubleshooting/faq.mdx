...
- **Semantic chunk retrieval** (`.llmwiki/embeddings.json` v3) narrows hundreds of pages down to a small top-K via cosine similarity before any LLM selection, with BM25 reranking on top.
