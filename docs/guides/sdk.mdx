...
An external coordinator such as llmflow owns process sequencing, human interaction
and revision policy. It calls core services for retained data and authorized
effects; it does not replace the compiler's authority checks.
