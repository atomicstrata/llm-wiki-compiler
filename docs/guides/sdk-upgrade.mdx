...
experiment input remain available. Core-only installation is opt-in; it does not
replace the default distribution. Node 24 remains the minimum, not a new requirement.

The extraction does not require a blanket migration to llmflow. See
